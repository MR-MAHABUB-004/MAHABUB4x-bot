...
module.exports.config = {
  ...
  permission: 0,
  credits: "Imran",
  description: "Send random image URL + random quote",
  prefix: true,
  category: "user",
  usages: "",
  cooldowns: 5,
...
"=== 「𝗣𝗿𝗲𝗳𝗶𝘅 𝐄𝐯𝐞𝐧𝐭」  ===\n  --❖-- 𝐈𝐭'𝐬 𝙈𝘼𝙃𝘼𝘽𝙐𝘽_𝙭_𝙍𝘼𝙃𝘼𝙈𝘼𝙉(✷‿✷) --❖--\n✢━━━━━━━━━━━━━━━✢\n\n°🐹💙🍒\n\n_𝗧𝗿𝘂𝘀𝘁 𝗺e 🔐💚\n°\n\n__!!☁️✨🌺আপনাকে পাওয়ার দাবি!আমি মৃত্যুর পরও ছাড়বো না,,🔐💚 🙂\n\n✢━━━━━━━━━━━━━━━✢\n\n𝐂𝐫𝐞𝐚𝐭𝐨𝐫 : 𝕄𝔸ℍ𝔸𝔹𝕌𝔹(✷‿✷)"
    ...
    const filePath = path.join(__dirname, `${uuidv4()}.jpg`);
    ...
    console.error("❌ Error in image+quote command:", err);
    api.sendMessage("⚠️ Something went wrong while sending the image.", event.threadID, event.messageID);
  }
};
